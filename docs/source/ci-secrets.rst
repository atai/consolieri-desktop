...
macOS shows **"Apple could not verify Consoleri.app…"** until the app is
...
Consoleri.app…"** after a clean download of the DMG.
...
3. Generate a password (label e.g. ``Consoleri CI``). Copy it once — this becomes
   ``APPLE_APP_SPECIFIC_PASSWORD``.
...
4. On a clean Mac: download the DMG from the GitHub Release, open the app.
   Gatekeeper should **not** show **"Apple could not verify Consoleri.app…"**.
