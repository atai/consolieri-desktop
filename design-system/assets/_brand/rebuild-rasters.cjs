#!/usr/bin/env node
/**
 * Rebuild all Consolieri raster brand assets from ONE locked mark geometry.
...
<svg xmlns="http://www.w3.org/2000/svg" width="${w}" height="${h}" viewBox="0 0 ${w} ${h}">
  ...
  <text x="${tx + tile + 56}" y="${h / 2 + 28}"
    ...
    font-size="120" font-weight="600" fill="${FG}" letter-spacing="-2">Consolieri</text>
...
<svg xmlns="http://www.w3.org/2000/svg" width="${w}" height="${h}" viewBox="0 0 ${w} ${h}">
  ...
  <text x="${w / 2}" y="${h / 2 + 70}" text-anchor="middle"
    font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif"
    font-size="64" font-weight="600" fill="${FG}">Consolieri</text>
...
<svg xmlns="http://www.w3.org/2000/svg" width="${w}" height="${h}" viewBox="0 0 ${w} ${h}">
  ...
  <text x="28" y="40" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif"
    font-size="18" font-weight="600" fill="${FG}">About Consolieri</text>
  ${markCentered(w / 2, 220, 2.2)}
  <text x="${w / 2}" y="360" text-anchor="middle"
    font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif"
    font-size="42" font-weight="600" fill="${FG}">Consolieri</text>
...
<svg xmlns="http://www.w3.org/2000/svg" width="${w}" height="${h}" viewBox="0 0 ${w} ${h}">
  ...
  <g transform="translate(64 48)">
    ...
    <text x="72" y="38" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif"
      font-size="28" font-weight="600" fill="${FG}">Consolieri</text>
  </g>
