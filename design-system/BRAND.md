# Consolieri Brand Guide

## Identity

**Consolieri** is a Windows-first Electron SSH host manager, terminal multiplexer, and infrastructure visualization tool for DevOps engineers.

- Product name is always **Consolieri** (never "Console" alone).
...
2. Bind Consolieri tokens — do not invent a new palette.
