...
description: Use this skill when creating Open Design artifacts that match the Consolieri desktop SSH host manager and infrastructure visualization tool.
user-invocable: true
---
...
**What is inside:**
- Source-backed visual foundations for Consolieri's dark production UI and light density prototype
...
**Source context:**
This design system is based on Consolieri v0.4.7 screenshots and an electron visualization prototype from Open Design project `eff54ab4-aed5-4420-b27a-179fa6c1cedb`. The product is a desktop Electron app for SSH host management, terminal sessions, connectivity reports, and network topology maps.

**When to use this skill:**
- Creating Consolieri-aligned mockups, prototypes, or review artifacts
