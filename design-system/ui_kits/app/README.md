...
Applied interface kit for **Consoleri** — the dark production Electron shell for SSH host management, connection profiles, keys, reports, and network maps. Built from v0.4.7 screenshot evidence and the Consoleri design-system tokens.
